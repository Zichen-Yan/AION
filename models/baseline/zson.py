...
from obj_utils.net_util import norm_col_init, weights_init, toFloatTensor
...
from datasets.constants import UNSEEN_FULL_OBJECT_8CLASS_LIST,UNSEEN_FULL_OBJECT_4CLASS_LIST, \
    SEEN_FULL_OBJECT_18CLASS_LIST, SEEN_FULL_OBJECT_14CLASS_LIST
import h5py
...
class SelfAttention_test(torch.nn.Module):
    def __init__(self, args):
        ...
        # lstm_input_sz = 6 + n * 5
        lstm_input_sz = (self.n * 5) + action_space
    ...
    def forward(self, model_input, model_options=None):
